function TaskCard() {
    return (
        <div class="flex p-[15px] gap-5 items-center bg-linear-to-r from-[#f67c7c] to-[#f63937] rounded-[30px] w-full">
        {/* Fazer a funcao JS para puxar o horário no banco */}
            <h1 class="text-[50px] text-[#333] font-bold px-[10px]">10:00</h1>
            <div class="flex bg-[#333] rounded-[30px] grid grid-cols-[5fr_1fr]">
                ...
                <button class="flex justify-center items-center my-[15px] mr-[15px] cursor-pointer">
                    <p class="text-[40px] text-center text-[#333] font-bold bg-linear-to-l from-[#797979] to-[#cfcfcf] p-[3px] rounded-[10px] aspect-square h-full">+</p>
                </button>        
            </div>
        </div>
    )

export function TaskCard({ task }) {
  return (
    <div className="flex p-[15px] gap-5 items-center bg-linear-to-r from-[#f67c7c] to-[#f63937] rounded-[30px] w-fit">
            <p className="text-[50px] text-[#333] font-bold px-[10px]">{task.time}</p>
        <div className="bg-[#333] rounded-[30px] grid grid-cols-[5fr_1fr]">
            <h3 className="flex items-center text-[50px] text-white font-bold min-w-0 truncate my-[15px] ml-[15px]">{task.title}</h3>
